...
gh_repo="papirus-mate-icon-theme"
gh_desc="Papirus MATE icon theme"
...
cat <<- EOF
  ...
  $gh_desc
  https://github.com/FreaxMATE/$gh_repo


EOF

: "${DESTDIR:=/usr/share/icons}"
: "${ICON_THEMES:=Papirus-MATE Papirus-MATE-Dark Papirus-MATE-Light}"
: "${TAG:=main}"
: "${uninstall:=false}"
...
_download() {
    ...
    wget -O "$temp_file" \
        "https://github.com/FreaxMATE/$gh_repo/archive/$TAG.tar.gz"
